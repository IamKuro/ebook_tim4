...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="medium-4 columns">
        ...
        Total Price: <strong id="totalPrice">Rp 0 </strong>
        </div>
    </div>
    <div class="medium-8 columns">
        <h1>Products List</h1>
        <div class="products">
            <div class="product medium-4 columns" data-name="Vivobook" data-price="6250000" data-id="0">
            <img src="images/vivobook.jpg" alt="" />
            <h3>Vivobook</h3>
            <h6>Rp 6.250.000</h6>
        ...
        <div class="product medium-4 columns" data-name="Surface Pro" data-price="8500000" data-id="1">
            <img src="images/predator.jpg" alt="" />
            <h3>Surface Pro</h3>
            <h6>Rp 8.500.000</h6>
            <input type="number" class="count" value="1" />
            <button class="tiny">Add to cart</button>
        ...
        <div class="product medium-4 columns" data-name="Predator" data-price="3850000" data-id="2">
